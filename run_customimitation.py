...
agent = ImitationAgent(config["flatland-sparse-small-tree-fc-apex-il-trainer"]["config"], env=FlatlandSparse)
agent.restore("checkpoints/custom_imitation)checkpoint_8466/checkpoint-8466")
#agent.restore("checkpoints/custom_e)checkpoint_2921/checkpoint-2921")
